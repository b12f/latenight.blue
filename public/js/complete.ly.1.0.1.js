...
function completely(container, config) {
    ...
    config.dropDownVisibility =             config.dropDownVisibility || 'hidden'; // to ensure we are in front of everybody
    config.name = config.name || container.id;
    ...
    txtInput.setAttribute("name", config.name);
    txtInput.setAttribute("placeholder", config.placeholder);
    wrapper.appendChild(txtInput);

    var dropDown = document.createElement('div');
    dropDown.style.position = 'absolute';
    dropDown.style.visibility = config.dropDownVisibility;
    ...
    var createDropDownController = function(elem) {
        ...
        var p = {
            ...
            refresh : function(token, array) {
                ...
                elem.style.visibility = config.dropDownVisibility;
            },
